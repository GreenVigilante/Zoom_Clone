...
reciever = AudioReceiver(local_ip, 6666)
...
def start_camera():
    ...
    if ca %2 == 1:
        ...
        camera= CameraClient(text_IP.get(1.0, "end-1c"), 9999)
...
def start_screen():
    ...
    if sc %2 ==1:
        ...
        screen = ScreenShareClient(text_IP.get(1.0, "end-1c"), 9999)
...
def start_audio():
    ...
    global au
    if au%2 ==1:
        audio = AudioSender(text_IP.get(1.0, "end-1c"), 8888)
...
def start_video():
    ...
    if vi%2 ==1:
        ...
        video = VideoClient(text_IP.get(1.0, "end-1c"), 9999, filename)
